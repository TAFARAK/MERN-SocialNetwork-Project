...
const CONNECTION_URL = 'mongodb+srv://socialnetwork:socialnetwork@cluster0.eyd0d.mongodb.net/?retryWrites=true&w=majority';

mongoose.connect(CONNECTION_URL).then(() => {
    console.log("SERVER connect to via database RUNNING ON:",PORT);
})
